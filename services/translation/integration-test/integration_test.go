...
import (
	...
	protov1 "github.com/evrone/translation-svc/docs/proto/v1"
	natsClient "evrone.local/common-pkg/nats/nats_rpc/client"
	rmqClient "evrone.local/common-pkg/rabbitmq/rmq_rpc/client"
