...
import (
	...
	amqprpc "github.com/evrone/translation-svc/internal/controller/amqp_rpc"
	"github.com/evrone/translation-svc/internal/controller/grpc"
	natsrpc "github.com/evrone/translation-svc/internal/controller/nats_rpc"
	"github.com/evrone/translation-svc/internal/controller/restapi"
	"github.com/evrone/translation-svc/internal/repo/persistent"
	"github.com/evrone/translation-svc/internal/repo/webapi"
	"github.com/evrone/translation-svc/internal/usecase/translation"
	"evrone.local/common-pkg/grpcserver"
	"evrone.local/common-pkg/httpserver"
	"evrone.local/common-pkg/logger"
	natsRPCServer "evrone.local/common-pkg/nats/nats_rpc/server"
	"evrone.local/common-pkg/postgres"
	rmqRPCServer "evrone.local/common-pkg/rabbitmq/rmq_rpc/server"
)
